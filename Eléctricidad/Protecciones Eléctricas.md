# Cuestionario de Electrotecnia y Protecciones Eléctricas ⚡

## 1. Funcionamiento del Arrancador Suave ⚙️
**Pregunta:** El arrancador suave, permite:
- [x] Arrancar y parar un motor trifásico lentamente
- [ ] Variar la velocidad de giro de un motor trifásico
- [ ] No sirve para arrancar un motor trifásico
...
- [ ] Utilizando un contactor
- [ ] Utilizando una protección termomagnética
- [x] Utilizando un relé de protección contra sobre y subtensión
...
- [x] Arrancar y parar un motor trifásico lentamente
- [ ] No sirve para arrancar un motor trifásico
- [x] Variar la velocidad de giro de un motor trifásico
...
- [ ] Descargar impactos directos de rayos
- [x] Proteger cargas sensibles, luego de que la instalación ya cuente con descargador Tipo 1 y Tipo 2
- [ ] Protección termomagnética para la instalación.
...
- [x] Si tengo en mi instalación motores
- [ ] Densidad de descargas a tierra, en donde se encuentre la instalación
- [ ] Tipo de acometida
